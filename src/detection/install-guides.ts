...
const INSTALL_GUIDES: Record<string, Record<Platform, string>> = {
  ImageMagick: {
    ...
    windows:
      "choco install imagemagick OR winget install ImageMagick.ImageMagick",
  ...
  cwebp: {
    ...
    windows:
      "choco install webp OR download from https://developers.google.com/speed/webp/download",
